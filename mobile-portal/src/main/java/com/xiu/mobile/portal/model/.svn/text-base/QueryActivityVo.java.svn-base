...
public class QueryActivityVo implements Serializable {
	...
	private String onlyOnSale;//仅有售商品
	...
	public String getOnlyOnSale() {
		return onlyOnSale;
	}

	public void setOnlyOnSale(String onlyOnSale) {
		this.onlyOnSale = onlyOnSale;
	}

	@Override
	public String toString() {
		return "QueryActivityVo [pageNum=" + pageNum + ", pageSize=" + pageSize + ", activityType=" + activityType + ", result=" + result 
				+ ", activityId=" + activityId + ", catId=" + catId + ", subType=" + subType + ", onlyOnSale=" + onlyOnSale + ", order=" + order 
				+ ", showType=" + showType + "]";
	}
