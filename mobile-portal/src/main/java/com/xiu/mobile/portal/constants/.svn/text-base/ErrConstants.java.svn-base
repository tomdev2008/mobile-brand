...
public final class ErrConstants {
    ...
    public class EIErrorCode {
        ...
        public final static String EI_PUC_ADD_ERR = "90202"; //添加提现申请异常
        public final static String EI_PUC_ADD_FAILED_ERR="90203";//添加提现申请失败
        public final static String EI_PUC_DEL_ERR = "90204"; //取消申请提现异常
        public final static String EI_PUC_DEL_FAILED_ERR="90205";//取消提现申请失败
        public final static String EI_PUC_BIZ_ERR = "90206"; //查询申请提现信息列表异常
        public final static String EI_PUC_BIZ_FAILED_ERR="90207";//查询申请提现信息列表失败
        public final static String EI_PUC_BIZ_INFO_ERR = "90208"; //查询特定申请提现信息详情异常
        public final static String EI_PUC_BIZ_INFO_FAILED_ERR="90209";//查询特定申请提现信息详情失败
        //UUC - 03
        ...
        public final static String EI_UUC_DELETE_USER_AUTHEN_ERR= "90333"; //删除用户认证信息失败
        //CSP - 04
        ...
        public final static String EI_CSP_ALL_REGION_FAILED_ERR = "90405";   // 获取全省市区异常
        //SSO - 05
        ...
        public static final String EI_TC_WAIT_COMMENT_ORDER_ERR= "91512";//查询待评论订单异常
        public static final String EI_TC_WAIT_COMMENT_ORDER_FAILED_ERR= "91513";//查询待评论订单失败
        public static final String EI_TC_ORDER_END_ERR= "91514";//更新已发货订单为已完结状态异常
        public static final String EI_TC_ORDER_END_FAILED_ERR= "91515";//更新已发货订单为已完结状态失败
        public static final String EI_TC_ORDER_DELETE_ERR = "91516";//删除订单异常
        public static final String EI_TC_ORDER_DELETE_FAILED_ERR= "91517";//删除订单失败
        public static final String EI_TC_ORDERDETAIL_LIST_FAILED_ERR = "91518";// 查询用户订单详情列表失败
        public static final String EI_TC_QUERY_BUYGOODSNUM_FAILED_ERR = "91519";//查询用户购买商品数量
        public static final String EI_TC_QUERY_INVOICE_FAILED_ERR = "91520";//查询用户购买商品数量
        public static final String EI_TC_QUERY_CAN_REFUND_ERR = "91521";//查询可售后服务订单
        public static final String EI_TC_ORDER_SAVE_PAY_TYPE_BIZ_ERR = "91522";//保存订单支付记录异常
        public static final String EI_TC_QUERY_ORDER_PAY_TYPE_BIZ_ERR = "91522";//查询订单支付记录异常
        ...
        //摇一摇
        public static final String EI_USER_SHAKETIME_ERR="919001"; //查询用户还有多少摇奖次数异常
        public static final String EI_USER_SHAKETIME_FAILED_ERR="919002"; //查询用户还有多少摇奖次数失败
        public static final String EI_MOBILE_SHAKE_ERR="919003"; //用户摇奖异常
        public static final String EI_MOBILE_SHAKE_FAILED_ERR="919004"; //用户摇奖失败
        public static final String EI_OTHERUSER_SHAKE_ERR="919005"; //查询其他用户中奖结果异常
        public static final String EI_OTHERUSER_SHAKE_FAILED_ERR="919006"; //查询其他用户中奖结果失败
        
        //绑定百度推送节点信息失败
        public final static String EI_BIND_BAIDU_DEVICE_ERROR= "92001"; //绑定百度推送节点信息失败
        public final static String EI_SET_DEFAULT_FERDRATE_INFO_ERROR= "92101"; //设置第三方默认用户信息失败
