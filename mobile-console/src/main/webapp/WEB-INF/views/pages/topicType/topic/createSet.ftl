...
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%"  class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">添加卖场集</span></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdBox">
					...
					<input type="radio" name="contentType" id="contentType_04" value="4" checked="true" /><label>卖场集</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th class="thList" scope="row"><span class="red">*</span>卖场集图片地址：</th>
				<td class="tdBox">
			...
			<tr>
				<th class="thList" scope="row"><span class="red">*</span>卖场焦点图是否显示：</th>
				<td class="tdBox">
	            	<input type="radio" name="displayBannerPic" id="displayType_01" value="Y" checked="true" /><label>显示</label>
					<input type="radio" name="displayBannerPic" id="displayType_02" value="N" /><label>不显示</label>
				</td>
			</tr>
			<tr>
