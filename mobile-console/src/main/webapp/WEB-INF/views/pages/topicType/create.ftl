...
<form id="saveMenuForm" name="saveMenuForm" enctype="multipart/form-data"  method="post" action="${rc.getContextPath()}/topicType/save">
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%"  class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">添加分类</span></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdBox">
					<table>
						<tr>
							<td style="width:185px;"><input type="radio" name="urlStatus" id="urlStatus_01" value="1" onclick="changeUrlStatus(1)"/><label>启用</label>
	            				<input type="radio" name="urlStatus" id="urlStatus_02" value="0" onclick="changeUrlStatus(2)" checked="true"/><label>停用</label>
	            			</td>
							<td>
			...
			<tr id="url_tr" style="display:none">
				...
				<td class="tdBox"><input type="text" id="url" name="url"value="" /></td>
			</tr>
			<tr>
				<th class="thList" scope="row">启用时间段：</th>
				<td class="tdBox">
				<input name="beginTime" type="text" id="beginTime" value=""  maxlength="11" style="width:120px;"  onfocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:00',minDate:'%y-%M-%d  00:00:00'})"  />
					--
					<input name="endTime" type="text" id="endTime" value=""  maxlength="11" style="width:120px;"  onfocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:00',minDate:'%y-%M-%d  00:00:00'})"  />
				</td>
			</tr>
			<tr>
