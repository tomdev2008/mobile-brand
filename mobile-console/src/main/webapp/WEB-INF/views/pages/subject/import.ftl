...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">导入专题</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="saveFindGoods" name="saveSubjects" action="${rc.getContextPath()}/subject/import_excel" method="post" enctype="multipart/form-data">
		...
		<table width="100%" class="table_bg05">
			...
			<tr>
				...
				<td class="tdBox">
					...
					<a href="javascript:void(0)" title="取消" onclick="return returnSubjectList();"class="ml10"><img src="${rc.getContextPath()}/resources/manager/images/button_cancel32.gif" class="mtb10" /></a>
...
<script type="text/javascript">
	...
	function downloadTemplate(){
		location.href = "${rc.getContextPath()}/subject/down";
	}
