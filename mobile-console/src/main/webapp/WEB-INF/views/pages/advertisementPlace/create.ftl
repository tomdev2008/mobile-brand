...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">添加广告位</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="addAdvPlaceForm" name="addAdvPlaceForm">
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">添加广告位</span></th>
			</tr>
			<tr>
				<th class="thList" scope="row"><span class="red">*</span>广告位code：</th>
				<td class="tdBox">
					<input type="text" name="code" id="code" value="" style="width:300px;"/>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
    ...
    //用Ajax提交信息
	function checkInfo(){
	    var params=$("#addAdvPlaceForm").serialize();
	    $.ajax({
					type : "POST",
					url : "${rc.getContextPath()}/advertisementPlace/save?format=json",
					data : params,
	                dataType: "text",
