...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">导入精选品牌</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="saveWellChosenBrand" name="saveWellChosenBrand" action="${rc.getContextPath()}/wellChosenBrand/import_excel" method="post" enctype="multipart/form-data">
<div class="adminMain_wrap">
	<div class="adminUp_wrap">
		...
		<dl class="adminPath clearfix">
			...
			<dd><a href="${rc.getContextPath()}/wellChosenBrand/list">精选品牌</a></dd>
			<dd class="last"><h3>导入精选品牌</h3>
			</dd>
		</dl>
	</div>
	<!--导航end-->
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">导入精选品牌</span></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdBox">
					<textarea id="content" name="content" style="width:400px;height:300px;">${(error!'')?html}</textarea>
			...
			<tr>
				...
				<td class="tdBox">
					...
					<a href="javascript:void(0)" title="取消" onclick="return returnWellChosenBrandList();"class="ml10"><img src="${rc.getContextPath()}/resources/manager/images/button_cancel32.gif" class="mtb10" /></a>
...
<script type="text/javascript">
	function checkExcel(file){
     ...
     function checkFileNullAndSubmit(){
	     ...
	     if(flag){
			document.getElementById("saveWellChosenBrand").submit();
	     }
     }
	
	function downloadTemplate(){
		location.href = "${rc.getContextPath()}/wellChosenBrand/down";
	}
	
	//取消事件，返回精选品牌列表
	function returnWellChosenBrandList(){
