	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			...
			<tr>
				...
				<td class="tdBox">
					  <input type="radio"  name="type" id="title" value="appstore"/>appstore : <input type="text" name="version" /></br>
					  <input type="radio"  name="type" id="title" value="appPro"/>appPro: &nbsp; <input type="text" name="version" />
				</td>
			</tr>
			<tr>
				<th class="thList" scope="row"><font class="red">*</font>是否强制升级：</th>
				<td class="tdBox">
	 					<input type="radio" name="needUpdate" class="displayStytle" value="0"    checked="checked" />否
	 					<input type="radio" name="needUpdate" class="displayStytle" value="1"    />是</td> 
				</td>
			</tr>
			<tr>
				<th class="thList" scope="row"><font class="red">*</font>是否启用：</th>
				<td class="tdBox">
	 					<input type="radio" name="status" class="displayStytle" value="0"    checked="checked" />停用
	 					<input type="radio" name="status" class="displayStytle" value="1"    />启用</td> 
				</td>
			</tr>
