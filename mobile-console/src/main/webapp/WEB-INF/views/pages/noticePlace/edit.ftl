...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">编辑公告位</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">编辑公告位</span></th>
			</tr>
			<tr>
			...
			<!-- <tr>
				<th class="thList" scope="row">公告位备注：</th>
				<td class="tdBox">
...
<script type="text/javascript">
	...
	function checkInfo(){
	    ...
	    $.ajax({
					type : "POST",
					url : "${rc.getContextPath()}/noticePlace/edit?format=json",
					data : params,
	                dataType: "text",
