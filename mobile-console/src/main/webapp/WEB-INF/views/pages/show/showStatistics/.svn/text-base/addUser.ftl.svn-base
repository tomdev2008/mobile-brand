...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">秀客新增用户统计</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="mainForm" name="mainForm" action="${rc.getContextPath()}/showStatistics/addUser" method="GET">
<div class="adminMain_wrap">
	...
	<div class="adminUp_wrap">
		...
		<dl class="adminPath clearfix">
				...
				<dd>秀客统计管理</dd>
				<dd class="last"><h3>秀客新增用户统计</h3></dd>
		</dl>
		<!-- 导航 end -->
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg01 table_hg01">
			...
			<tr>
			    <td>${statistics.TIMES!''}</td>
			    <td><#if statistics.COUNTS??>${statistics.COUNTS}<#else>0</#if></td>
			    <td></td>
			</tr>
		    </#list>
		    <#else>
...
<script type="text/javascript">
	...
	function exportData(){
		...
		var beginTime = $("#beginTime").val();
		var endTime = $("#endTime").val();
		location.href = "${rc.getContextPath()}/showStatistics/addUserExport?timeType="+timeType+"&beginTime="+beginTime+"&endTime="+endTime;
	}
