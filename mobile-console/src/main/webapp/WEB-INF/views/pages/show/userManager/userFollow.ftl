...
<form id="mainForm" name="mainForm" action="${rc.getContextPath()}/userManager/viewUserFollow" method="GET">
...
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg01 table_hg01">
			...
			<tr>
			    <td><#if follow.CREATE_DATE??>${follow.CREATE_DATE?string('yyyy-MM-dd HH:mm:ss')}</#if></td>
			    <td><a href="javascript:void(0);" onclick="viewShowUser('${follow.USER_ID!''}');" title="${follow.PET_NAME!''}">${follow.PET_NAME!''}</a></td>
			<tr>
		    </#list>
		    <#else>
