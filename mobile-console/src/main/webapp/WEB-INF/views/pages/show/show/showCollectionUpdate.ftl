...
<div class="adminMain_wrap">
	...
	<!--导航end-->
<form id="addSubjectForm" name="addSubjectForm" enctype="multipart/form-data" method="post" action="${rc.getContextPath()}/show/updateShowCollection">
	<!--菜单内容-->
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			...
			<tr>
				...
				<td class="tdBox">
				 	  <input type="hidden"  name="showCollectionId" id="showCollectionId" value="${showCollectionVO.showCollectionId!''}" /> 
					  <input type="text"  name="name" id="name" maxlength="100" value="${showCollectionVO.name!''}" style="width:500px;"/> 
				</td>
			</tr>
			...
			<tr>
				...
				<td class="tdBox">
					  <img style="width:480px;height:219px;" src="http://6.xiustatic.com${showCollectionVO.listImgPath!''}" />
			...
			<tr>
				...
				<td class="tdBox">
				      <img style="width:480px;height:219px;" src="http://6.xiustatic.com${showCollectionVO.detailImgPath!''}" />
			...
			<tr>
				...
				<td class="tdBox">
					<textarea name="detailText" rows="12" cols="100" maxlength="1000">${showCollectionVO.detailText!''}</textarea>
				</td>
			</tr>
