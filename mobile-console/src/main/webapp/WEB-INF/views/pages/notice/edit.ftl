...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">编辑公告</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="editNoticeForm" name="editNoticeForm"  action="${rc.getContextPath()}/notice/edit">
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">编辑公告</span></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdBox">
				    <input type="checkbox" name="effect" id="effect"  <#if advertisement.effective==1>checked="true"</#if> />
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
   ...
   //验证信息
	...
	function checkInfo(advPlaceId,advPlaceName){
	    var params=$("#editNoticeForm").serialize();
	    $.ajax({
					type : "POST",
					url : "${rc.getContextPath()}/notice/edit?format=json",
					data : params,
	                dataType: "text",
