...
<div class="adminMain_wrap" style="width:600px;">
	...
	<div class="adminContent clearfix">
		<table  class="table_bg05">
			...
			<tr>
				<th class="thList" scope="row">是否显示卖场倒计时：</th>
				<td class="tdBox">
	            	<select name="isShowCountDown" id="isShowCountDown">
			           <option value="0" <#if topic.isShowCountDown?? && topic.isShowCountDown ==0> selected="selected"  </#if> >否</option>
					   <option value="1" <#if topic.isShowCountDown?? && topic.isShowCountDown ==1> selected="selected"  </#if> >是</option>
					</select>
				</td>
			</tr>
			<tr>
				<th class="thList" scope="row">结束后是否可被搜索：</th>
				<td class="tdBox">
	            	<select name="isEndCanBeSearch" id="isEndCanBeSearch">
			           <option value="0" <#if topic.isEndCanBeSearch?? && topic.isEndCanBeSearch ==0> selected="selected"  </#if> >否</option>
					   <option value="1" <#if topic.isEndCanBeSearch?? && topic.isEndCanBeSearch ==1> selected="selected"  </#if> >是</option>
					</select>
				</td>
			</tr>
			<tr>
