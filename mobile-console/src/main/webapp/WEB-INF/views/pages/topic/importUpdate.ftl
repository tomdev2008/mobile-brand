...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">批量导入修改卖场</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<form id="saveFindGoods" name="saveFindGoods" action="${rc.getContextPath()}/topic/import_excel" method="post" enctype="multipart/form-data">
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">批量导入修改卖场<</span></th>
			</tr>
			<tr>
...
<script type="text/javascript">
	...
	function downloadTemplate(){
		location.href = "${rc.getContextPath()}/topic/down";
	}
	
	//取消事件，返回单品发现管理列表
	function returnGoodsList(){
	  location.href = "${rc.getContextPath()}/topic/list";
	}
</script>
</html>