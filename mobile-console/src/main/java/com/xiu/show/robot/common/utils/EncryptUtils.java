...
/*		for (char i = 65; i < 91; i++) {
	...
	public static String getAESKeySelf() {
		return ShowRobotConstants.MPORTAL_AES_KEY_SELF;
	}

	public static String getAESKeyShare() {
		return ShowRobotConstants.MPORTAL_AES_KEY_SHARE;
	}

	public static String getAESKeyPayForOthers() {
		return ShowRobotConstants.MPORTAL_AES_KEY_PAYFOR_OTHERS;
	}
	...
	public static void main(String args[]) {
		...
		String news = encryptByAES(ss, "CnxLp4rVV0ld2MYS");
		System.out.println(news);

		news = decryptByAES(news, "CnxLp4rVV0ld2MYS");
		System.out.println(news);
