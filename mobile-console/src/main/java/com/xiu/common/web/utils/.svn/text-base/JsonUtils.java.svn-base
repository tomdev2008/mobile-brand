...
public class JsonUtils {
	...
	public static String bean2jsonP(String callback, Object bean) {
		/*String str = JSON.toJSONString(bean,SerializerFeature.WriteMapNullValue,SerializerFeature.WriteNullListAsEmpty,
	...
	/**
	 * json bean格式转换 bean下null属性也展示节点
	 * @return
	 */
	public static String beanjsonP(String callback, Object bean) {
		String str = JSONSerializer.toJSON(bean).toString();
		StringBuffer sb = new StringBuffer(str);
		if(callback != null) {
			sb.insert(0, callback + "(");
			sb.append(")");
	...
	public static void main(String[] args) {
		String json="{\"content\":\"沾沾喜气！\",\"id\":66072,\"pictureList\":[{\"clipPicUrl\":\"/storage/sdcard1/XIU/show/clip/1450663759021.png\",\"clipPicWithTagUrl\":\"/storage/sdcard1/XIU/show/tag/1450663770246.png\",\"originalPicUrl\":\"/storage/sdcard1/Pictures/xiu/IMG_1450663748439.jpg\",\"originalThumbnailUrl\":\"/storage/sdcard1/XIU/show/thumbnail/1450663754870.png\",\"ratio\":{\"height\":4,\"ratioType\":2,\"wHRatioValue\":0.75,\"width\":3},\"ratioType\":2,\"tagList\":[{\"bottomMargin\":0,\"direction\":2,\"id\":0,\"leftMargin\":331,\"name\":\"喜糖\",\"objectId\":0,\"picId\":0,\"ratioType\":0,\"result\":false,\"rightMargin\":0,\"topMargin\":425,\"type\":1,\"xPosition\":53,\"yPosition\":51}],\"uploadSuccess\":false}],\"terminal\":\"4\",\"topic\":{\"isHot\":\"0\",\"result\":false,\"tilte\":\"落叶飘零\",\"topicId\":750}}";
