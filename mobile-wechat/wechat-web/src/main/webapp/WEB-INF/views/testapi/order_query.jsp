...
<script type="text/javascript">
	...
	function orderQuery(){
		$.ajax({
			type : 'POST',
			dataType:'json',
			url :"<c:url value='/testapi/orderQuery'/>",
...
<body>
	<div id="w_login" class="wrapper">
		...
		<form id="query_form" method="POST" action='<c:url value="/testapi/orderQuery"/>'>
		<fieldset>
			<br>
			<legend ><span style="font-size:20px;color:red">微信API接口测试 ==> 订单查询接口</span></legend>
			<p>
