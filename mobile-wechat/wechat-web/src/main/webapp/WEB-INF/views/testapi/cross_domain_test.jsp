...
<script type="text/javascript">
	...
	function crossDomainTest(){
		$.ajax({
			type : 'POST',
			dataType:'json',
			url :"<c:url value='/testapi/crossDomainTest'/>",
			data : {
				"url":$("#url").val()
			},
			cache : false,
...
<body>
	<div id="w_login" class="wrapper">
		...
		<fieldset>
			...
			<p>
				<label for="email"><span style="font-size:20px;color:red">访问URL：</span></label> 
				<input id="url" name="url" type="text" height="50px" required style="font-size:20px;">
			</p>
			<br>
			<input id="query_btn" type="button" class="login_btn" value="跨域访问" /> <br>
		</fieldset>
		<table>
			<tr>
