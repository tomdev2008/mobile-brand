...
<script Language="javascript">
	...
	function getPartnerKey(){
		return "bec543dc05ae588174fdba3ccba60ef6";
	}
	...
	function getPackage(){
		...
		var notify_url = "http://wap.xiu.com";//支付成功后将通知该地址
	...
	function getAppId(){
		return "wxbfd5bd9dd172c9a6";
	}
	            
	function getAppKey(){
		return "JAFMNGSUqytlVnd5QfC6sfYiX84ggPKfE0NH5UQgfAQrckfkQDE69mCPfVnLwmhqhjo8u1CYPJaMkbSq5ghro9xTkEV7frNNZq0fF1tLYpOARVKaqiS7FFLfAVA8D80o";
...
<body>
	...
	<form name="form1" target="_blank">
		<table border="1">
			<TR>
				<th>商品名</th>
				<th><INPUT value="走秀网商品，全球同价" name="body" id="4"></th>
			<TR>
				<th>总金额</th>
