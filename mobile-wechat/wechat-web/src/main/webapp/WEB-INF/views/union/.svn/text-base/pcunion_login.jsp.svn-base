...
<%@ page import="com.xiu.mobile.wechat.web.constants.WebContants"%>
<!DOCTYPE html>
<html>
<head>
...
<!--  
<link rel="stylesheet" href="../resources/css/m_base.css?v=2014091701" />
<link rel="stylesheet" href="../resources/css/m_login.css?v=2014091701" />
-->
<!--  
<script type="text/javascript" src="../resources/js/m_base.js?v=2014091701" /></script>
<script type="text/javascript" src="../resources/js/m_validate.js?v=2014091701" /></script>
-->
<script type="text/javascript" src="../resources/js/jquery-1.7.2.js" /></script>
<script type="text/javascript">$(function(){$('#login_form').submit();})</script>
</head>
...
<div class="wrap login" >	
	...
	<header class="header">	
		<div class="l-nav">
			...
			<section>微信联合登陆</section>	
			<section></section>
		</div>		
	</header> 
	-->
	<section class="innerContent">	
			<form id="login_form" method="POST" action="<%=WebContants.PC_UNION_LOGIN_URL%>">
				<fieldset>
					<!-- 
					<div class="form-area">							
						<div class="f-field">
					...
					<div class="f-field f-btn-area" >
						...
						<!-- <input type="submit" id="J-submit" class="f-orange-btn" value="登&nbsp;录"/>	 -->				
					</div>
				</fieldset>
			</form>	
			<!--
