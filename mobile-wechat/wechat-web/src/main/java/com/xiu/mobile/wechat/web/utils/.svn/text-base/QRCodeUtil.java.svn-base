...
public class QRCodeUtil {
	public static void main(String[] args) throws Exception {
		// QRCodeEncoder();
		 QRCodeDecoder();
//		QRCodeUtil.QRCodeEncoderNestedPicture("Hello World !", 85, 85, "D:\\test.jpg", "D:\\2013-03-13.jpg");
	}
	 ...
	 * @throws Exception
	 */
	public static void QRCodeEncoder() throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void QRCodeDecoder() throws Exception {
		File imagePath = new File("d:/test.jpg");
		String encoding = "utf-8";
	...
	// 二维码写码器
	private static Writer mutiWriter = new MultiFormatWriter();
	 ...
	 *            二维码生成的地址
	 */
	public static void QRCodeEncoderNestedPicture(String content, int width, int height, String srcImagePath,
			...
			for (int x = 0; x < matrix.getWidth(); x++) {
				...
				// 在图片四周形成边框
						...
						|| (x > halfW + IMAGE_HALF_WIDTH - FRAME_WIDTH && x < halfW + IMAGE_HALF_WIDTH + FRAME_WIDTH
								&& y > halfH - IMAGE_HALF_WIDTH - FRAME_WIDTH && y < halfH + IMAGE_HALF_WIDTH
								+ FRAME_WIDTH)
						|| (x > halfW - IMAGE_HALF_WIDTH - FRAME_WIDTH && x < halfW + IMAGE_HALF_WIDTH + FRAME_WIDTH
								&& y > halfH - IMAGE_HALF_WIDTH - FRAME_WIDTH && y < halfH - IMAGE_HALF_WIDTH
								+ FRAME_WIDTH)
