...
import com.xiu.mobile.simple.common.util.EncryptUtils;
...
public interface GlobalConstants {
	...
	public final static String TENCENT_QQ = ParseProperties.getPropertiesValue("UNION_TENCENT_QQ");
	/** 联合登陆用户来源  TENCENT_WECHAT(腾讯微信)*/
	public final static String TENCENT_WECHAT = ParseProperties.getPropertiesValue("UNION_TENCENT_WECHAT");
	/** 联合登陆用户来源  ALIPAY(支付宝)*/
	public final static String ALIPAY = ParseProperties.getPropertiesValue("UNION_ALIPAY");
	/** 联合登陆用户来源  SINA_WEIBO(新浪微博)*/
	public final static String SINA_WEIBO = ParseProperties.getPropertiesValue("UNION_SINA_WEIBO");
	/** 联合登陆用户来源  NETEASE(网易)*/
	public final static String NETEASE = ParseProperties.getPropertiesValue("UNION_NETEASE");
	/** 联合登陆用户来源  MOBILE_139(139邮箱)*/
	public final static String MOBILE139 = ParseProperties.getPropertiesValue("UNION_MOBILE_139");
	/** 联合登陆用户来源  FANLI_51(返利网)*/
	public final static String FANLI_51 = ParseProperties.getPropertiesValue("UNION_FANLI_51");
	...
	public final static String PAY_SIGN_KEY = ParseProperties.getPropertiesValue("pay.sign.key");
